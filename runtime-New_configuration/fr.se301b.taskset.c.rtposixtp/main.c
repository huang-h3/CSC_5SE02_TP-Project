...
thread_queue_t T3_q = { &T3_q_rez, &T3_q_event, (union thread_config*) &T3_info, 0, 0, 
{ 
 &T3_q_pi
} };
...
extern sporadic_thread_config_t T4_info;
thread_queue_t T4_q = { &T4_q_rez, &T4_q_event, (union thread_config*) &T4_info, 0, 0, 
{ 
 &T4_q_pi
} };
